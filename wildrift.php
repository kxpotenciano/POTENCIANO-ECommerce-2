...
<img src="img/wildcores.png" style="float: left; padding: 50px; object-fit: fill;">
		...
		<div class="container">
			<div class="row">
			 ...
			 <div class="row" style="padding: 10px;">
				<div class="col-4"> 
					<input type="button" class="btn btn-outline-primary shopbtn" name="125 Wild Cores" value="125 Wild Cores" onclick="getName(this.name)" id="125wc"></input>
				</div>
				<div class="col-4">
					<input type="button" class="btn btn-outline-primary shopbtn" name="380 Wild Cores" value="380 Wild Cores" onclick="getName(this.name)" id="380wc"></input>
				</div>
				<div class="col-4">
					<input type="button" class="btn btn-outline-primary shopbtn" name="790 Wild Cores" value="790 Wild Cores" onclick="getName(this.name)" id="790wc"></input>
				</div>

			 </div>
			<div class="row" style="padding: 10px;">
				<div class="col-4">
					<input type="button" class="btn btn-outline-primary shopbtn" name="1650 Wild Cores" value="1650 Wild Cores" onclick="getName(this.name)" id="1650wc"></input>
				</div>
				<div class="col-4">
					<input type="button" class="btn btn-outline-primary shopbtn" name="2850 Wild Cores" value="2850 Wild Cores" onclick="getName(this.name)" id="2850wc"></input>
				</div>
				<div class="col-4">
					<input type="button" class="btn btn-outline-primary shopbtn" name="2800 Wild Cores" value="2800 Wild Cores" onclick="getName(this.name)" id="5800wc"></input>
				</div>
			</div>
			<div class="row" style="padding: 10px;">
					<div class="col-4">
						<input type="button" class="btn btn-outline-primary shopbtn" name="12500 Wild Cores" value="12500 Wild Cores" onclick="getName(this.name)" id="12500wc"></input>
					</div>
			</div>
		</div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body modalbody">
      	...
      	<div class="row">
      		<div class="col-6">Riot ID: <span id="uidconfirm"></span></div>
      		<div class="col-6"></div>
      	</div><br>
      	<div class="row">
